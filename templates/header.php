<header id="main_header" class="flex_container">
        <a href="#" title="Vers l'accueil"><img src="assets/img/logo-parc-asterix.png" alt="Logo Parc Astérix" id="nav_logo"></a>
        <nav id="main_nav">
            <div id="nav_toggle_open">
                <span></span>
                <span></span>
                <span></span>
            </div>
